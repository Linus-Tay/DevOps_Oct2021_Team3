...
#         self.assertEqual(insertBuild(sample_map,bPool,"D1",testBuild,1),2)
#         self.assertEqual(insertBuild(sample_map,bPool,"C1",testBuild,2),3)
#         self.assertEqual(insertBuild(sample_map,bPool,"B1",testBuild,3),4)
#         self.assertEqual(insertBuild(sample_map,bPool,"A1",testBuild,4),5)


#     #test case for when user tries to insert building on the same column but different row
#     # such as A1 -> A2 -> A3 -> A4
#     def testBuild_SameCol(self):
#         self.assertEqual(insertBuild(sample_map,bPool,"A2",testBuild,1),2)
#         self.assertEqual(insertBuild(sample_map,bPool,"A3",testBuild,2),3)
#         self.assertEqual(insertBuild(sample_map,bPool,"A4",testBuild,3),4)
...
#         self.assertEqual(insertBuild(sample_map,bPool,"B4",testBuild,1),2)
#         self.assertEqual(insertBuild(sample_map,bPool,"C3",testBuild,2),2)
...
#         self.assertEqual(getBuildName(sample_map,2,22),testBuild)
...
#         self.assertEqual(insertBuild(sample_map,bPool,"B2",testBuild,1),2)
#         self.assertEqual(insertBuild(sample_map,bPool,"C2",testBuild,2),3)
...
#         self.assertEqual(insertBuild(sample_map,bPool,"A2",testBuild,3),4)
#         self.assertEqual(insertBuild(sample_map,bPool,"D2",testBuild,4),5)

#         #different col different row adjacent build
#         self.assertEqual(validateXYInput(sample_map,([2,4,4,4,4],[4,22,4,16,10])),True)
#         self.assertEqual(insertBuild(sample_map,bPool,"A1",testBuild,5),6)
#         self.assertEqual(validateXYInput(sample_map,([6,4,4,4,4],[22,22,4,16,10])),True)
#         self.assertEqual(insertBuild(sample_map,bPool,"D3",testBuild,6),7)
